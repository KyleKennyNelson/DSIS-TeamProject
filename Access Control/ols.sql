...
--DISCONNECT then RE-CONNECT to continue

--Create levels, compartments and groups
-- label tag = sum(level)* 10 + sum(compartment)* 100 + sum(group) neu trung thi +10 moi lan
EXECUTE SA_COMPONENTS.CREATE_LEVEL('region_policy',1000, 'L1', 'SINHVIEN');
EXECUTE SA_COMPONENTS.CREATE_LEVEL('region_policy',2000, 'L2', 'NHANVIENCOBAN');
EXECUTE SA_COMPONENTS.CREATE_LEVEL('region_policy',3000, 'L3', 'GIAOVU');
EXECUTE SA_COMPONENTS.CREATE_LEVEL('region_policy',4000, 'L4', 'GIANGVIEN');
EXECUTE SA_COMPONENTS.CREATE_LEVEL('region_policy',5000, 'L5', 'TRUONGDONVI');
EXECUTE SA_COMPONENTS.CREATE_LEVEL('region_policy',6000, 'L6', 'TRUONGKHOA');
--
